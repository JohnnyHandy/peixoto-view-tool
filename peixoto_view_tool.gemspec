...
require_relative "lib/peixoto_view_tool/version"

Gem::Specification.new do |spec|
  spec.name          = "peixoto_view_tool"
  spec.version       = PeixotoViewTool::VERSION
  spec.authors       = ["Roger Peixoto"]
  spec.email         = ["duarterogerpeixoto@gmail.com"]
